...
const [sticky, setSticky] = useState(false);
  ...
  return (
    ...
    <div className={` max-w-screen-2xl container mx-auto md:px-20 px-4 dark:text-white fixed top-0 left-0 right-0 z-50 ${
          sticky
 ...
 <label className="swap swap-rotate">
  ...
  <div>
    <a className="bg-black text-white p-2 rounded hover:bg-slate-800 duration-300 cursor-pointer" 
